...
<body>
	...
	<h1 class="formHeaders"> Managers </h1> 
   ...
   ?>
	...
	<table style="margin-top:10px">
		...
		<?php
			...
			$query = "SELECT * FROM amanager_view
					  INNER JOIN address_view ON amanager_view.addressID=address_view.addressID
	...
	<form> 
				...
				//if delete has an input
					...
					$query_dstaff = "DELETE FROM amanager_view
